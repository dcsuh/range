...
Using the host-parasite matrix and the host-ecoregion matrix, we can determine all of the possible ecoregions that a parasite might fill (assuming they fill all or a proportion of their host's ecoregions)
