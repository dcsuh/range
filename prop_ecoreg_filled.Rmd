...
```{r}
get_violin(type_ratios) + geom_violin(fill = "#D81B60")
get_violin(mode_ratios) + geom_violin(fill = "#1E88E5")
get_violin(spec_ratios) + geom_violin(fill = "#FFC107")
get_violin(prev_ratios) + geom_violin(fill = "#004D40")
get_violin(int_ratios) + geom_violin(fill = "#D01BD6")
```
