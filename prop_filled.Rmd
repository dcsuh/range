...
type_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot()
mode_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot()
spec_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot()
prev_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot()
int_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot()
```
