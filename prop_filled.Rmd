...
type_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot() + geom_jitter()
mode_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot() + geom_jitter()
spec_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot() + geom_jitter()
prev_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot() + geom_jitter()
int_ratios %>% filter(ratio<1 & ratio>0) %>% ggplot(., aes(x=binary, y=ratio)) + geom_boxplot() + geom_jitter()
```
